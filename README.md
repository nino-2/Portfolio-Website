...
```js
git clone https://github.com/nino-2/Portfolio-Website.git
...
This portfolio is MIT-licensed so you are free to use it as an inspiration or you can just copy the whole thing (excluding my personal content of course), I don't really mind. Just make sure you link back to [ninotech.com.ng][site] on the footer section as attribution to the original source.
...
[env-api]: https://github.com/nino-2/Portfolio-Website/blob/main/lib/env.api.ts
